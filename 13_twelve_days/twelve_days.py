...
def main():
    ...
    print(result, file=outfile_args)
...
def verse(day):
    ...
    verses = [f'On the {ordinal[day-1]} day of Christmas,', 'My true love gave to me,']
    for n in reversed(range(0, day)):
        verses.append('And ' + text[n].replace('A', 'a', 1)) if n == 0 and day > 1 else verses.append(text[n])
